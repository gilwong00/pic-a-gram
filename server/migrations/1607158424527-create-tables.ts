...
export class createTables1607158424527 implements MigrationInterface {
  name = 'createTables1607158424527';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "post" ADD CONSTRAINT "FK_fe7588ad0ee893e819b774f79ed" FOREIGN KEY ("photoIdId") REFERENCES "image"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "post" DROP CONSTRAINT "FK_fe7588ad0ee893e819b774f79ed"`
    );
